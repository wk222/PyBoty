...
async def create_conversation(
    ...
    return services.conversations.create_conversation(req.title if req else None)
...
async def get_history(
    ...
    return {"thread_id": thread_id, "messages": services.conversations.get_history(thread_id)}
