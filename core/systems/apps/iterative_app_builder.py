...
from core.systems.apps.app_manager_registry import get_shared_app_manager
...
from core.systems.agents.subagent_sandbox import build_subagent_sandbox
from core.assets.agents.capability_profile import AgentCapabilityProfile
from core.assets.agents.middleware_profile import AgentMiddlewareProfile
...
Use this as the top-level App Runtime entrypoint when you want a working app in one step."""
    ...
    def _run(
        ...
        from core.systems.apps.app_creator import UpdateAppFileTool, TestAppApiTool
        from core.systems.apps.app_verifier import VerifyAppTool, ReadAppFileTool
