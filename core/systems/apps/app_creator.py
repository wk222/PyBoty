...
from core.systems.apps.app_manager_registry import get_shared_app_manager, set_shared_app_manager
...
"""
    ...
    def _validate_file(mgr: AppManager, app_name: str, file_path: str) -> list[dict[str, str]]:
        ...
        from core.systems.apps.app_verifier_checks import check_api, check_html, check_javascript
