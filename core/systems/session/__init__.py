...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    # session_notes (rolling-notes scheduler — formerly memory.session_memory_extractor)
    "SessionNotesScheduler": (".session_notes", "SessionMemoryScheduler"),
    "SessionNotesConfig": (".session_notes", "SessionMemoryConfig"),
    "SessionMemoryScheduler": (".session_notes", "SessionMemoryScheduler"),
    "SessionMemoryConfig": (".session_notes", "SessionMemoryConfig"),
    "SessionMemoryExtractor": (".session_notes", "SessionMemoryScheduler"),
}
