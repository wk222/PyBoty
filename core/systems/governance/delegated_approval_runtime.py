...
class DelegatedApprovalResolutionRuntime:
    ...
    def resolve_payload(
        ...
        *,
        ...
        """Resolve the current state of an approval into a result dictionary.
        
        Normalization to specific L2 schemas (like DelegationPayload) is handled 
        by higher-level consumers.
        """
        ...
        if isinstance(payload, str):
            try:
                ...
                return {"response": payload, "agent_name": agent_name, "task": task}
