...
Inspired by OpenClaw's ``system-events.ts``: lightweight in-memory queue
for human-readable events that should be prefixed to the next prompt.
Events are session-scoped, deduped, and auto-pruned.
"""
