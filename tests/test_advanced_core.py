...
class TestMemoryCategories:
    def test_memory_category_enum_values(self):
        from core.semantic_memory import MemoryCategory
    ...
    def test_classify_category_preference(self):
        from core.semantic_memory import _classify_category
...
class TestInjectionGuard:
    def test_rejects_injection_pattern(self):
        from core.semantic_memory import _looks_like_injection
...
class TestCaptureFilter:
    def test_rejects_too_short(self):
        from core.semantic_memory import _capture_filter
...
class TestMemoryEntry:
    def test_memory_entry_has_category(self):
        from core.semantic_memory import MemoryEntry
...
class TestForgetMemoryTool:
    def test_tool_exists(self):
        from core.memory_tools import ForgetMemoryTool
        tool = ForgetMemoryTool()
        assert tool.name == "forget_memory"

    def test_tool_in_get_memory_tools(self):
        from core.memory_tools import get_memory_tools
...
class TestLLMTaskValidation:
    def test_validate_required_fields(self):
        from core.llm_task_tool import _validate_against_schema
...
class TestExtractJSON:
    def test_plain_json(self):
        from core.llm_task_tool import _extract_json
...
class TestLLMTaskTool:
    def test_tool_attributes(self):
        from core.llm_task_tool import LLMTaskTool
        tool = LLMTaskTool()
...
class TestContextEngineRegistry:
    ...
    def test_get_nonexistent(self):
        from core.context_engine import get_engine
        assert get_engine("nonexistent_engine_xyz") is None


class TestDefaultContextEngine:
    def test_assemble_basic(self):
        from core.context_engine import DefaultContextEngine
        engine = DefaultContextEngine()
        messages = [
...
class TestContextEngineProtocol:
    def test_default_engine_implements_protocol(self):
        from core.context_engine import ContextEngine, DefaultContextEngine
        engine = DefaultContextEngine()
...
class TestMetricBucket:
    def test_record_and_snapshot(self):
        from core.diagnostics import MetricBucket
        b = MetricBucket()
        b.record(10)
        b.record(20)
        s = b.snapshot()
...
class TestGenerateUnifiedDiff:
    def test_identical_texts(self):
        from core.diff_tool import generate_unified_diff
...
class TestDiffStats:
    def test_no_changes(self):
        from core.diff_tool import diff_stats
...
class TestViewDiffTool:
    def test_identical(self):
        from core.diff_tool import ViewDiffTool
        tool = ViewDiffTool()
...
class TestDiffSummaryTool:
    def test_summary(self):
        from core.diff_tool import DiffSummaryTool
...
class TestGetDiffTools:
    def test_returns_three_tools(self):
        from core.diff_tool import get_diff_tools
...
class TestCronDelivery:
    def test_to_dict(self):
        from core.task_scheduler import CronDelivery
...
class TestStaggerDelay:
    def test_deterministic(self):
        from core.task_scheduler import _stagger_delay
...
class TestScheduledTaskDelivery:
    def test_task_with_delivery(self):
        from core.task_scheduler import CronDelivery, ScheduledTask
        task = ScheduledTask(
            name="test",
...
class TestTokenEstimation:
    def test_english_text(self):
        from core.context_engine import _estimate_tokens
