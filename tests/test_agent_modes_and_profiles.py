"""Tests for Agent Modes, Profiles, and Governance Control.

Consolidates:
1. test_agent_control.py
2. test_agent_modes.py
3. test_mode_profiles.py
"""
...
# ── Section 1: Agent Control Policies ─────────────────────────────────
...
# ── Section 2: Agent Modes and Dynamic Autoloader ─────────────────────
