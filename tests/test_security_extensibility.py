...
class TestExternalContentWrapping:
    def test_wrap_adds_boundary(self):
        from core.external_content import wrap_external_content
...
class TestInjectionDetection:
    def test_detects_ignore_instructions(self):
        from core.external_content import detect_suspicious_patterns
...
class TestRedactSuspicious:
    def test_redacts_injection(self):
        from core.external_content import redact_suspicious
...
class TestSanitise:
    def test_full_pipeline(self):
        from core.external_content import sanitise
...
class TestRiskLevel:
    def test_low_no_approval(self):
        from core.tool_risk import RiskLevel
...
class TestToolRiskRegistry:
    def test_default_dangerous_tools(self):
        from core.tool_risk import RiskLevel, ToolRiskRegistry
    ...
    def test_check_returns_dict(self):
        from core.tool_risk import ToolRiskRegistry
...
class TestApplyDirectives:
    def test_apply_to_config(self):
        from core.directive_parser import apply_directives_to_config, parse_directives
...
class TestMediaTypeDetection:
    def test_image_types(self):
        from core.media_understanding import MediaType, detect_media_type
...
class TestMediaPipeline:
    def test_pipeline_no_providers(self):
        from core.media_understanding import MediaPipeline
    ...
    def test_local_provider(self):
        from core.media_understanding import LocalMediaProvider, MediaPipeline
...
class TestMediaProvider:
    def test_local_provider_protocol(self):
        from core.media_understanding import LocalMediaProvider, MediaProvider

        provider = LocalMediaProvider()
        assert isinstance(provider, MediaProvider)

    def test_openai_provider_protocol(self):
        from core.media_understanding import MediaProvider, OpenAIMediaProvider
...
class TestURLExtraction:
    def test_extract_plain_urls(self):
        from core.link_safety import extract_urls
...
class TestSSRFProtection:
    def test_blocks_localhost(self):
        from core.link_safety import is_blocked_host
...
class TestPluginManifest:
    def test_parse_manifest(self, tmp_path):
        from core.plugin_manifest import parse_manifest
...
class TestPluginRegistry:
    def test_register_and_get(self):
        from core.plugin_manifest import PluginManifest, PluginRegistry
...
class TestHookTypes:
    def test_all_hook_types_exist(self):
        from core.hook_context import HookType
...
class TestHookContexts:
    def test_message_received_context(self):
        from core.hook_context import MessageReceivedContext
    ...
    def test_agent_bootstrap_context(self):
        from core.hook_context import AgentBootstrapContext
    ...
    def test_tool_call_context(self):
        from core.hook_context import ToolCallContext
...
class TestHookRegistry:
    def test_register_and_run(self):
        from core.hook_context import HookRegistry, HookType, MessageReceivedContext
    ...
    def test_handler_count(self):
        from core.hook_context import HookRegistry, HookType
